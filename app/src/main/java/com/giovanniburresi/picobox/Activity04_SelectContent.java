...
public class Activity04_SelectContent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_04_selectcontent);
    ...
    public void prosegui(View v){
        startActivity(new Intent(this, Activity05_SelectImages.class));
    }


    public void selectBy(View v){
